...
def setThreshold(newThres, stockName):
    global thresholds
    thresholds[stockName] = newThres

def checkThreshold(newPrice, stockName):
    global currentPos, thresholds
    currentThresh = thresholds[stockName]
    if newPrice > currentThresh and currentPos[stockName] > 0:
        currentPos[stockName] = 0
    elif newPrice < currentThresh and currentPos[stockName] < 0:
        currentPos[stockName] = 0
